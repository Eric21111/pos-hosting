  ...
  return (
    <div
      ...
      <div className="px-6 pb-4 w-full space-y-6">
        ...
        {/* Main Row: KPIs + Sales Chart (left) | Active Employees + Sales By Category (right) */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {/* Left Column: KPIs + Sales Over Time */}
              ...
              <div
                ...
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p className={`text-xs font-bold mt-1 ${theme === "dark" ? "text-gray-300" : "text-gray-700"}`}>
                      Total Sales
                    </p>
