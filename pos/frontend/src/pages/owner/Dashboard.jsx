...
const Dashboard = () => {
  ...
  const [topSellingSort, setTopSellingSort] = useState("most"); // 'most', 'least'
  const [lowStockFilter, setLowStockFilter] = useState("All"); // 'All', 'Out of Stock', 'Low Stock'
  ...
  // Custom palette from design: Pink, Blue, Peach, Green
